\documentclass[11pt, twocolumn]{article} % Switched to standard twocolumn for better figure placement
...
% Optional: Makes links clickable but black (professional look)
\hypersetup{
    colorlinks=true,
    linkcolor=black,
    filecolor=magenta,      
...
% --- TITLE & LOGOS (Spanning the full width of the page) ---
\twocolumn[{%
    \begin{center}
        % Direct image placement (no \begin{figure}) fixes the moving logo bug
